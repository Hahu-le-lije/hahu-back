...
| Field | Type            | Required | Rules              |
|-------|-----------------|----------|--------------------|
| `pin`   | integer or null | No       | Must be six digits |
...
Important frontend note: show or store the new PIN immediately if the parent needs to share it. It cannot be retrieved again. If no pin is sent in the request body, an autogenerated PIN is used.
